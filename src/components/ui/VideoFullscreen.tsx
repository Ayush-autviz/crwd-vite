    ...
    >
      ...
      <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        ...
        <video
          ref={videoRef}
          src={src}
          className="w-full max-h-full object-contain cursor-pointer z-10"
          onClick={togglePlay}
        ...
        <div className="absolute bottom-0 left-0 right-0 h-1.5 bg-white/10 z-50">
          <div
            className="h-full bg-white transition-all duration-100 shadow-[0_0_8px_rgba(255,255,255,0.4)]"
