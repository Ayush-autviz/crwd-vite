  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center py-8 md:py-12">
        ...
        <span className="ml-1.5 md:ml-2 text-xs xs:text-sm md:text-sm text-gray-600">Loading notifications...</span>
      </div>
    );
  }
  ...
  if (transformedNotifications.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 md:py-16 px-3 md:px-4">
        ...
        <h3 className="text-sm xs:text-base md:text-lg font-semibold text-gray-900 mb-1.5 md:mb-2">No notifications yet</h3>
        <p className="text-xs xs:text-sm md:text-sm text-gray-500 text-center max-w-sm">
          ...
          <div className="flex items-start gap-3 md:gap-4">
            ...
            {(() => {
              ...
              return notification.userId ? (
                ...
                >
                  {/* Avatar sizing: Base 8, XS 9, MD 10 */}
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-700 text-xs xs:text-sm md:text-sm mb-1.5 md:mb-2">
                {(() => {
                  ...
                  // Remove amount from donation description
