          ...
          <div className="flex flex-col items-start gap-2.5 md:flex-row md:items-start md:gap-4 lg:gap-6">
            ...
            <div className="flex-1 min-w-0 text-left w-full md:w-auto">
              ...
              <button
                ...
                className="text-foreground font-semibold text-xs md:text-sm lg:text-base xl:text-lg hover:underline flex items-center gap-1 self-start"
              >
                Create collective
                <ArrowRight className="w-3 h-3 md:w-4 md:h-4 lg:w-5 lg:w-5 xl:w-6 xl:w-6" />
              </button>
            </div>
          </div>
        </CardContent>
