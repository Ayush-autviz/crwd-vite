    ...
    <div className="w-full py-2 md:py-6 md:max-w-2xl md:mx-auto">
      <div className="bg-white rounded-lg border border-gray-200 p-3 md:p-6 flex flex-col md:flex-row items-start gap-2.5 md:gap-4 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-sm md:text-lg text-gray-900 mb-0.5 md:mb-1 md:hidden">My Donation Box</h3>
        </div>

        {/* Content */}
        <div className="flex-1 min-w-0">
          <h3 className="font-bold text-sm md:text-lg text-gray-900 mb-0.5 md:mb-1 hidden md:block">My Donation Box</h3>
