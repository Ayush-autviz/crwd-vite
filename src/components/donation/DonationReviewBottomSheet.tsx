          ...
          <div className="flex-1 overflow-y-auto px-4 md:px-6 py-4 md:py-6">
            ...
            <div className="mb-6 md:mb-8">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base md:text-lg font-bold text-gray-900">Your Donation Box</h3>
                {onEditCauses && (
                  <button
                    onClick={onEditCauses}
                    className="text-sm md:text-base font-bold text-[#1600ff] hover:underline transition-all cursor-pointer"
                  >
                    Adjust split
                  </button>
                )}
          ...
          <div className="px-5 md:px-7 py-4 md:py-6 border-t border-gray-100 bg-white">
            ...
            >
              {activateBoxMutation.isPending ? (
                ...
                <>
                  <span>{showEditButton ? "Confirm and Activate" : "Confirm Donation"}</span>
                </>
              )}
            </button>
