  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottom Sheet */}
        <div
          className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl md:rounded-t-3xl shadow-2xl transition-transform duration-300 max-h-[90vh] md:max-h-[85vh] overflow-hidden flex flex-col ${isAnimating ? 'translate-y-0' : 'translate-y-full'
            }`}
        ...
        >
          ...
          <div className="px-4 md:px-6 py-3 md:py-4 border-t border-gray-200 bg-white">
            <button
              ...
              className={`w-full bg-gray-800 hover:bg-gray-900 text-white font-semibold py-3 md:py-4 rounded-full transition-colors text-sm md:text-base flex items-center justify-center gap-2 ${activateBoxMutation.isPending || showLogoAnimation ? 'opacity-50 cursor-not-allowed' : ''
                }`}
            >
