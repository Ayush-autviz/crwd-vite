  ...
  return (
    <div className="flex items-center justify-between h-14 md:h-16 p-3 md:p-4 border-b">
      ...
      {showCloseButton && (
        <button
          onClick={handleClose}
          className="flex items-center justify-center h-7 w-7 md:h-8 md:w-8 rounded-full bg-gray-100 text-gray-700 hover:bg-gray-200 transition-colors cursor-pointer"
          aria-label="Close"
        >
