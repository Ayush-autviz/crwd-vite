...
interface DonationBoxProps {
  ...
  collectiveName?: string; // Collective name for display in header
}

const DonationBox = ({ tab = "setup", preselectedItem, activeTab, fromPaymentResult, preselectedCauses, preselectedCausesData, preselectedCollectiveId, collectiveName }: DonationBoxProps) => {
              ...
              <>
                {step === 1 ? (
                  ...
                  <div className="flex-1 mx-3 md:mx-4 mt-3 md:mt-4 mb-4 flex flex-col">
                    ...
                    <div
                      className={`p-3 md:p-4 flex justify-between items-center ${isMobile ? "mb-20" : ""
                        }`}
                    >
