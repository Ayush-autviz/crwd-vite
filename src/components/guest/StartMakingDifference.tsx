  ...
  return (
    <div className="bg-[#a955f7] py-6 md:py-16 px-4 md:px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <a href="/onboarding"
          className="bg-[#aeff30] hover:bg-[#93c902] text-black font-[900] px-8 md:px-10 py-4 md:py-7 rounded-full text-base xs:text-lg md:text-lg shadow-lg inline-block"
        >
