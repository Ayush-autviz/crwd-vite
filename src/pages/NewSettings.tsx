    ...
    <div className="h-full flex flex-col">
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="mb-6 bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            ...
            <div className="px-5 pb-8 space-y-5">
              {/* First Name */}
              <div>
                <Label className="mb-2 text-sm font-bold text-gray-900">First Name</Label>
                <Input
              ...
              {/* Last Name */}
              <div>
                <Label className="mb-2 text-sm font-bold text-gray-900">Last Name</Label>
                <Input
              ...
              {/* Location */}
              <div>
                <Label className="mb-2 text-sm font-bold text-gray-900">Location</Label>
                <div className="relative">
              ...
              {/* Bio */}
              <div>
                <Label className="mb-2 text-sm font-bold text-gray-900">Bio</Label>
                <Textarea
                  value={formData.bio}
                  onChange={(e) => {
                  ...
                  disabled={!isEditMode}
                  placeholder="Bio"
                  className="bg-gray-100 border-0 min-h-[100px]"
                  rows={4}
                />
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 mb-6">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 bg-gray-50 rounded-lg px-4 py-2 mb-3">
                  <Input
            ...
            <div className="p-6">
                ...
                {faqData.map((faq, index) => (
                  <div key={index}>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-between py-4 px-0 hover:bg-gray-50 rounded-lg transition-colors"
                    >
                      <span className="text-base font-semibold text-gray-900 text-left flex-1 mr-3">
                        {faq.question}
                      </span>
                      <ChevronDown
              ...
              <div className="mt-8 space-y-0">
                <button
                  ...
                  className="w-full text-left py-3 px-0 text-base font-medium text-gray-900 hover:text-blue-600 transition-colors"
                >
                  Contact Support
                </button>
                <button
      ...
      <Sheet open={showPasswordDialog} onOpenChange={setShowPasswordDialog}>
        <SheetContent side="bottom" className="h-[75vh] max-h-[75vh] p-0 flex flex-col">
          ...
          <div className="px-4 flex-1 overflow-y-auto">
            <SheetHeader>
              <SheetTitle className="text-2xl font-bold text-gray-900">Change Password</SheetTitle>
      ...
      <Sheet open={showEmailDialog} onOpenChange={setShowEmailDialog}>
        <SheetContent side="bottom" className="h-[75vh] max-h-[75vh] p-0 flex flex-col">
          ...
          <div className="px-4 flex-1 overflow-y-auto">
            <SheetHeader>
              <SheetTitle className="text-2xl font-bold text-gray-900">Change Email</SheetTitle>
              <SheetDescription className="text-sm text-gray-500">
            ...
            <form onSubmit={handleEmailSubmit} className="mt-6 space-y-4">
              <div>
                ...
                {emailErrors.newEmail && (
                  <p className="text-sm text-red-500 mt-1">{emailErrors.newEmail}</p>
                )}
              </div>
              <div>
                ...
                {emailErrors.confirmEmail && (
                  <p className="text-sm text-red-500 mt-1">{emailErrors.confirmEmail}</p>
                )}
              </div>
              <div className="flex gap-2 pt-4 pb-6">
                <Button type="button" variant="outline" onClick={() => setShowEmailDialog(false)} className="flex-1">
                  Cancel
                </Button>
                <Button type="submit" disabled={updateEmailMutation.isPending} className="flex-1">
      ...
      <Sheet open={showOTPDialog} onOpenChange={setShowOTPDialog}>
        <SheetContent side="bottom" className="h-[50vh] max-h-[50vh] p-0 flex flex-col">
          ...
          <div className="px-4 flex-1 overflow-y-auto">
            <SheetHeader>
              <SheetTitle className="text-2xl font-bold text-gray-900">Verify Email</SheetTitle>
              <SheetDescription className="text-sm text-gray-500">
            ...
            <form onSubmit={handleOTPSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex gap-2 pt-4 pb-6">
                <Button type="button" variant="outline" onClick={() => setShowOTPDialog(false)} className="flex-1">
                  Cancel
                </Button>
                <Button type="submit" disabled={verifyEmailMutation.isPending} className="flex-1">
