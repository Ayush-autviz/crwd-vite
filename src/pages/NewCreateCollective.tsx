    ...
    return (
      <div className="min-h-screen bg-white flex flex-col items-center">
        ...
        <div className="sticky top-0 z-10 w-full flex items-center gap-4 p-4 border-b bg-white">
          ...
          <h1 className="font-bold text-xl text-foreground">Create a CRWD Collective</h1>
        </div>
        <div className="mb-8">
          <div className="w-16 h-16 rounded-full mt-5 bg-blue-100 flex items-center justify-center">
        ...
        <p className="text-base text-gray-700 text-center max-w-md mb-12 leading-relaxed">
          You pick the causes. You invite the people. They give monthly. No money touches your hands. You just rally the movement.
        </p>
        <Button
          onClick={() => navigate('/onboarding')}
          className="bg-[#1600ff] hover:bg-[#1400cc] text-white font-semibold rounded-lg px-2 py-6 text-base w-full max-w-xs"
        >
          Get Started
        </Button>
      </div>
    ...
    return (
      <>
        <div className="min-h-screen bg-white">
          ...
          <div className="flex flex-col gap-4 items-center justify-center h-[65vh] md:h-[75vh] px-4">
            <div className="w-full max-w-md gap-4">
              <img
                src="/icons/CRWD.png"
                alt="CRWD Logo"
                className="w-1/3 h-1/3 object-contain mx-auto mb-6"
              />
  ...
  return (
    <>
      <div className="min-h-screen bg-white">
        ...
        <div className="px-4 py-6 lg:max-w-[60%] lg:mx-auto">
          {/* Collective Name */}
          ...
          {/* Footer Buttons */}
          <div className="fixed bottom-0 left-0 right-0 bg-white  p-4 flex items-center justify-between gap-4 z-10 md:max-w-[60%] mx-auto">

            <Button
              onClick={handleCreateCollective}
              className="bg-[#1600ff] hover:bg-[#1400cc] text-white font-semibold rounded-full px-6 w-full"
