    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 z-10 bg-white border-b px-4 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <SelectTrigger className="w-[120px] h-[40px] border-none bg-gray-100/80 hover:bg-gray-100 font-medium text-gray-900 rounded-lg focus:ring-0 focus:ring-offset-0">
              <SelectValue placeholder="Year" />
            </SelectTrigger>
            <SelectContent align="end" className="min-w-[120px] bg-white border border-gray-100 shadow-lg rounded-lg">
