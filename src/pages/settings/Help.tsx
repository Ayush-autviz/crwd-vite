  ...
  const faqData: FAQItem[] = [
    {
      ...
      answer:
        "CRWD is a social platform that connects people with causes they care about. You can join or create CRWDs (communities) focused on specific charitable causes, participate in group donations, and track your collective impact.",
    },
    {
      question: "How do I join a CRWD?",
      answer:
        "You can join a CRWD by browsing our community directory, searching for causes you're interested in, or receiving an invitation from a friend. Simply click 'Join' on any CRWD that interests you.",
    },
    {
      question: "How do donations work?",
      answer:
        "CRWD facilitates group donations to verified non-profit organizations. When your CRWD decides to support a cause, members can contribute any amount they're comfortable with. All donations are secure and go directly to the chosen organization.",
    },
    {
      question: "Is my personal information safe?",
      answer:
        "Yes, we take privacy seriously. Your personal information is encrypted and never shared with third parties without your consent. You control what information is visible to other CRWD members.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "We verify all non-profit organizations through official databases and documentation to ensure they are legitimate 501(c)(3) organizations in good standing.",
    },
    {
      question: "What happens if a CRWD becomes inactive?",
      answer:
        "Inactive CRWDs are archived after 90 days of no activity. Members are notified and can reactivate the CRWD or join similar active communities.",
    },
  ];
